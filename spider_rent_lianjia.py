...
def spider(url):
    ...
    for house in houses:
        ...
        subway_distance_info= soup_detail.find('div', {'id': 'around'}).find_all('ul')[1]
        subway_list=[]
        for li in subway_distance_info.find_all("li"):
            ...
            subway_list.append([line,name,distance]) 
        #around > ul:nth-child(4) > li:nth-child(1) > span:nth-child(1)
        #//*[@id="around"]/ul[2]/li[1]/span[1]
        print(subway_list)
